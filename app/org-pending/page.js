  ...
  return (
    <main style={{ minHeight: '100vh', backgroundColor: '#FEFFFF', color: '#2A272A', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
      ...
      <div style={{ textAlign: 'center', maxWidth: '440px' }}>
        <div style={{ width: '64px', height: '64px', borderRadius: '50%', backgroundColor: '#FEF9E7', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 1.5rem', fontSize: '2rem' }}>
          ⏳
        </div>
        ...
        <p style={{ color: '#94B7A2', fontSize: '0.9rem', lineHeight: 1.7, marginBottom: '2rem' }}>
          Your organization account is currently pending admin approval. You will receive a notification
          once your application has been reviewed. This typically takes 1–2 business days.
        </p>
        <button
